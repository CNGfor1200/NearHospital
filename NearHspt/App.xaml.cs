...
namespace NearHspt
{
  public partial class App : Application
  {
    ...
    public static int[,] hospitalsInRange = new int[2000, 2];
    ...
    public static string RegWhen = "March-18-2018";
    ...
    public App()
    {
      ...
      //
      if ((Preferences.Get("inFirstRun", "default_value")).Contains("BgU"))
      {
        inFirstRun = false;
      }
      else
      ...
      if (inFirstRun)
      {
        Preferences.Set("inFirstRun", "BgU");
        Preferences.Set("leadInSound", "0");
        //
        //
        // Autonotification for all three name groups
        Preferences.Set("setAutoemail1", "0");
        Preferences.Set("setAutoemail2", "0");
        Preferences.Set("setAutoemail3", "0");
        // 
        // sound pitch
        Preferences.Set("SpeechPitch", "50");
        // sound rate
        Preferences.Set("SpeechVolume", "100");
        Preferences.Set("Assessment", "0");
        Preferences.Set("TrainingMode", "0");

        // Speech to text
        Preferences.Set("SpeechInput1", "");
        Preferences.Set("SpeechInput2", "");
      }
